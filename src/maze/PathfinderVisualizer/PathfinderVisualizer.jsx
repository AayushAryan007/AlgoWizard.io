...
export default class PathfinderVisualizer extends Component {
  ...
  handleMouseEnter(row, col) {
    ...
    if (
      ...
      !this.state.startNodeIsPressed &&
      !this.state.finishNodeIsPressed
    )
      return; //if not pressed already, don't do anything
  ...
  handleMouseLeave(row, col) {
    if (!this.state.startNodeIsPressed && !this.state.finishNodeIsPressed)
      return; //if not pressed already, don't do anything
    let newGrid;
    if (this.state.startNodeIsPressed) {
  ...
  render() {
    const { grid, mouseIsPressed, startNodeIsPressed, finishNodeIsPressed } =
      this.state;
    ...
    return (
      <div>
        <div id="openModal-about" class="modalDialog">
          <div>
            <a href="#saka" title="Close" className="close">
              X
            </a>
            <div class="cPanelContainer">
              <div className="cPanelHeader">
                ...
                <span>
                  A pathfinding algorithm seeks to find the shortest path
                  between two points.
                </span>{" "}
                <br />
                <span>
                  This application visualizes various pathfinding algorithms in
                  action on a 2D grid.
                </span>
                ...
                <ul>
                  <p>
                    ...
                    The father of pathfinding algorithms; guarantees the
                    shortest path
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>A*'s Algorithm</span> &nbsp; - &nbsp; Uses
                ...
                <ul>
                  <p>
                    {" "}
                    - &nbsp;<span>Toggle</span> &nbsp; - &nbsp; You can toggle
                    obstacles on or off
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Obstacle options</span> &nbsp; - &nbsp; You
                    can select between three different obstacle densities
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Draw obstacles</span> &nbsp; - &nbsp; You can
                    click or click and drag to generate obstacles with the
                    pointer
                  </p>
                </ul>
                ...
                <ul>
                  <p>
                    {" "}
                    - &nbsp;<span>Nodes</span> &nbsp; - &nbsp; A point in the
                    grid
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Navy blue nodes</span> &nbsp; - &nbsp;
                    Obstacles
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Blue nodes</span> &nbsp; - &nbsp; Nodes that
                    have been considered as part of the part
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Yellow nodes</span> &nbsp; - &nbsp; Nodes that
                    are part of the final path
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Green node</span> &nbsp; - &nbsp; The starting
                    point
                  </p>
                  <p>
                    {" "}
                    - &nbsp;<span>Red node</span> &nbsp; - &nbsp; The end point
                  </p>
                  <p>
                    {" "}
                    <b>
                      <span>Note</span> &nbsp; - &nbsp;You can drag the start
                      point (in green) and endpoint (in red) to your desired
                      position
                    </b>
                  </p>
                </ul>
              ...
              <div className="cPanelFooter">
                <span>
                  For more information of the algorithms, check them out on the
                  following links.
                </span>
                <ul>
              ...
              <ul className="nav-links">
                <label className="dropdown">
                  ...
                  <ul className="dd-menu">
                    <li onClick={() => this.visualizeDijkstra()}>
                      Dijkstra's Algorithm
                    </li>
                ...
                <label className="dropdown">
                  <div className="dd-button">Obstacle Options</div>
                  <input type="checkbox" className="dd-input" id="test"></input>
                  <ul className="dd-menu">
                    <li onClick={() => this.changeObstacles()}>
                      Change Obstacles
                    </li>
                    <li onClick={() => this.changeDensity(0.095)}>
                      Low Density Obstacles
                    </li>
                    <li onClick={() => this.changeDensity(0.13)}>
                      Medium Density Obstacles
                    </li>
                    <li onClick={() => this.changeDensity(0.25)}>
                ...
                <li>
                  {" "}
                  <a href="#openModal-about">App Info</a>{" "}
                </li>
              </ul>
            )}
          </ul>{" "}
                ...
                {row.map((node, nodeIdx) => {
                  ...
                  return (
                    <Node
                      ...
                      whileMousePressed={(row, col) =>
                        this.handleMousePress(row, col)
                      }
