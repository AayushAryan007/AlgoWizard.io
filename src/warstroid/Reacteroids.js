...
export default class Reacteroids extends Component {
  ...
  render() {
    ...
    if (!this.state.inGame) {
      endgame = (
        <div className="endgame text-white">
          <p>Game over, man!</p>
          <p>{message}</p>
    ...
    return (
      <div>
        {endgame}
        <span className="score current-score text-white">
          Score: {this.state.currentScore}
        </span>
        <span className="score top-score text-white">
          Top Score: {this.state.topScore}
        </span>
        <span className="controls text-white">
